...
describe("POST /api/query", () => {
  ...
  it("handles POST request and returns a JSON response", async () => {
    ...
    const req = {
      ...
      url: `${NEXT_PUBLIC_BASE_URL}/api/query`,
    ...
    expect(fetchSpy).toHaveBeenCalledWith(`${NEXT_PUBLIC_BASE_URL}/query`, {
      method: "POST",
...
describe("POST /api/query - Error Handling for !response.ok", () => {
  let fetchSpy: jest.SpyInstance;
  let jsonMock: jest.SpyInstance;
