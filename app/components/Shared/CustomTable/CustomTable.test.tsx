...
jest.mock("@/app/utils/helpers", () => ({
  dateFormatForHistoryPage: jest.fn(() => ["2024-01-15", "formatted"]),
...
// Mock CSS modules
jest.mock("./CustomTable.module.css", () => ({
...
const mockRenderRow = (item: any, idx: number) => {
